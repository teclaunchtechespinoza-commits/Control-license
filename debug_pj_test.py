...
response = requests.post("https://saasguard.preview.emergentagent.com/api/clientes-pj", json=test_data, headers=headers)
...
if response.status_code != 200:
    ...
    # Clean up
    requests.delete(f"https://saasguard.preview.emergentagent.com/api/clientes-pj/{client_id}", headers=headers)
