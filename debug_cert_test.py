...
response = requests.post("https://tenantmanager.preview.emergentagent.com/api/clientes-pj", json=test_data, headers=headers)
...
if response.status_code != 200:
    ...
    requests.delete(f"https://tenantmanager.preview.emergentagent.com/api/clientes-pj/{client_id}", headers=headers)
