...
class LicenseManagementAPITester:
    def __init__(self, base_url="https://multitenant-saas-1.preview.emergentagent.com/api"):
...
if __name__ == "__main__":
    ...
    backend_url = "https://multitenant-saas-1.preview.emergentagent.com/api"
    ...
    if len(sys.argv) > 1:
        ...
        if test_name == "super_admin_fix":
            ...
            print("Testes disponíveis: super_admin_fix, rbac_maintenance, multi_tenancy, structured_logging, all")
            sys.exit(1)
    else:
