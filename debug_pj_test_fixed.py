...
response = requests.post("https://securemanage-2.preview.emergentagent.com/api/clientes-pj", json=test_data, headers=headers)
...
if response.status_code != 200:
    ...
    requests.delete(f"https://securemanage-2.preview.emergentagent.com/api/clientes-pj/{client_id}", headers=headers)
