...
def test_license_integration():
    ...
    response = requests.post("https://multisaas.preview.emergentagent.com/api/clientes-pj", json=pj_data, headers=headers)
    ...
    response = requests.post("https://multisaas.preview.emergentagent.com/api/licenses", json=license_data, headers=headers)
    if response.status_code != 200:
    ...
    response = requests.get(f"https://multisaas.preview.emergentagent.com/api/licenses/{license_id}", headers=headers)
    if response.status_code != 200:
    ...
    response = requests.get("https://multisaas.preview.emergentagent.com/api/stats", headers=headers)
    if response.status_code != 200:
    ...
    # 5. Cleanup
    requests.delete(f"https://multisaas.preview.emergentagent.com/api/licenses/{license_id}", headers=headers)
    requests.delete(f"https://multisaas.preview.emergentagent.com/api/clientes-pj/{pj_client_id}", headers=headers)
