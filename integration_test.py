...
def test_license_integration():
    ...
    response = requests.post("https://tenantbay.preview.emergentagent.com/api/auth/login", json=admin_credentials)
    ...
    response = requests.post("https://tenantbay.preview.emergentagent.com/api/clientes-pj", json=pj_data, headers=headers)
    ...
    response = requests.post("https://tenantbay.preview.emergentagent.com/api/licenses", json=license_data, headers=headers)
    if response.status_code != 200:
    ...
    response = requests.get(f"https://tenantbay.preview.emergentagent.com/api/licenses/{license_id}", headers=headers)
    if response.status_code != 200:
    ...
    response = requests.get("https://tenantbay.preview.emergentagent.com/api/stats", headers=headers)
    if response.status_code != 200:
    ...
    # 5. Cleanup
    requests.delete(f"https://tenantbay.preview.emergentagent.com/api/licenses/{license_id}", headers=headers)
    requests.delete(f"https://tenantbay.preview.emergentagent.com/api/clientes-pj/{pj_client_id}", headers=headers)
